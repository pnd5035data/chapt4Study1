...
class ExperimentController {
  ...
  _wireEvents() {
    ...
    document.addEventListener("keydown", (event) => {
      if (this.phase === "demographicQuestions") {
  ...
  makeCSVText() {
    ...
    if (this.data.demographics) {
      rows.push([]);
      rows.push(["DEMOGRAPHIC_DATA"].map(escapeCsvValue).join(","));
      const demoHeaders = ["participantId", "sex", "race", "age", "political", "sexOrient", "education"];
      rows.push(demoHeaders.map(escapeCsvValue).join(","));
      rows.push([
        this.data.participantId,
        this.data.demographics.sex || "",
        this.data.demographics.race || "",
        this.data.demographics.age || "",
        this.data.demographics.political || "",
        this.data.demographics.sexOrient || "",
        this.data.demographics.education || ""
      ].map(escapeCsvValue).join(","));
    }
